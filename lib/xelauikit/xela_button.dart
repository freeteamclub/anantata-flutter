  ...
  Widget build(BuildContext context) {
    ...
    if (text != null) {
      children.add(
          Text(
            text!,
            style: (size == XelaButtonSize.MEDIUM ? XelaTextStyle.XelaButtonMedium : size == XelaButtonSize.SMALL ? XelaTextStyle.XelaButtonSmall : XelaTextStyle.XelaButtonLarge).apply(color: foregroundColor),
          )
      );
    }
    ...
    return Opacity(
      opacity: state == XelaButtonState.DISABLED ? 0.48 : 1,
      child: RawMaterialButton(
        ...
        onPressed: state == XelaButtonState.DISABLED ? null : onPressed,
